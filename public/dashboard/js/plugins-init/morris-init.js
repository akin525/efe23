	...
	var dlabMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#208b37', 'rgb(255, 92, 0)', '#ffaa2b'],
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#EE3C3C', '#ffaa2b', '#208b37'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(69,43,144)', 'rgb(0, 171, 197)', '#208b37'],
				resize: true
		...
		var barChart = function(){
			...
			//bar chart
				Morris.Bar({
					...
					ykeys: ['a', 'b', 'c'],
					labels: ['A', 'B', 'C'],
					barColors: ['#208b37', '#ffaa2b', '#ff9f00'],
					hideHover: 'auto',
					gridLineColor: 'transparent',
					resize: true,
					barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#208b37', 'rgb(16, 202, 147)', 'rgb(255, 92, 0)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
